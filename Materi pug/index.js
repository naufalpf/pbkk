...
app.listen(3000);
console.log('buka browser ke localhost:3000/image untuk melihat gambar');
console.log('buka browser ke localhost:3000/form untuk melihat form');
console.log('Buka localhost:3000/cookie untuk set cookie');
